...
const ExperienceCard = ({ experience, theme }) => {
    return (
        <div className={`portfolio-card ${theme === 'light' ? 'bg-gray-200' : 'bg-gray-800'} shadow-lg cursor-pointer transform transition-transform duration-300 hover:scale-105`}>
